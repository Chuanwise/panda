...
public class PlayerAdapter extends CommandSenderAdapter<Player> implements Player {
...
//    }
    ...
    public void sendBlockChange(Location location, int i, byte b) {
        commandSender.sendBlockChange(location, i, b);
    }
    ...
    public void awardAchievement(Achievement achievement) {
        commandSender.awardAchievement(achievement);
    }

    @Override
    public void removeAchievement(Achievement achievement) {
        commandSender.removeAchievement(achievement);
    }

    @Override
    public boolean hasAchievement(Achievement achievement) {
        return commandSender.hasAchievement(achievement);
    }
//
//    @Override
//    public void awardAchievement(Achievement achievement) {
